        ...
        children: <Widget>[
          ...
          Padding(padding: const EdgeInsets.only(right: 450.0 ),
            child: Column(
              ...
              children: <Widget>[
                ...
                Text('İÇECEKLER...', style: GoogleFonts.ultra(fontSize: 21.0, color: Colors.blueGrey),
                ),
              ],
            ),
          ),
          ...
          Container(
            ...
            child: ListView(
              ...
              children: <Widget>[
                tasarlaListItem('Activia','Assets_Varlıklar/resimler/activia.jpg',  '20.50 TL'),
                tasarlaListItem('Ayran','Assets_Varlıklar/resimler/ayran.jpg',  '19.99 TL'),
                tasarlaListItem('Maden Suyu','Assets_Varlıklar/resimler/madensuyu.jpg',  '20.59 TL'),
                tasarlaListItem('Meyve Suyu','Assets_Varlıklar/resimler/meyvesuyu.jpg',  '24.50 TL'),
                tasarlaListItem('Su','Assets_Varlıklar/resimler/su.jpg',  '7.90 TL'),
              ],
            ),
          ),
        ],
